#ifndef MULTI_DEVICE_COMPILER_KERNELS_GPU_CUDAREDUCEKERNELUTILS_CUH_
#define MULTI_DEVICE_COMPILER_KERNELS_GPU_CUDAREDUCEKERNELUTILS_CUH_
...
#pragma unroll
  for (int mask = 16; mask > 0; mask >>= 1)
    val = add(val,
              __shfl_xor_sync(FINAL_MASK, val, mask,
